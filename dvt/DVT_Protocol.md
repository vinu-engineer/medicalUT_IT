...
| `SWR-GUI-005` | Unit tests | HAL contract verified by GTest |
| `SWR-GUI-006` | Unit tests | Simulation sequence verified by GTest |
...
| `SWR-GUI-010` | Unit tests + automated GUI | Persistence via `ConfigTest`, runtime controls via GUI automation |
...
| `tests/unit/test_hal.cpp` (`HALTest`, `HALTestNoInit`, `SimSequenceTest`) | 12 | `SWR-GUI-005`, `SWR-GUI-006` |
| `tests/unit/test_config.cpp` (`ConfigTest`) | 10 | `SWR-GUI-010` |
| **Total** | **275** | |
